...
calendar/social summaries, Yahoo/Google RSS, release-focused company/IR news
discovery, optional Reddit search, StockTwits messages, optional full text from
linked articles, and the existing
